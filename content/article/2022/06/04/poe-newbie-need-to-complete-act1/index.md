...
Freesing Pulise で敵をなぎ倒し、Raise Zombie を敵の死体に使うだけで突破できる。
...
このステージでは特段やることがないのだが、毎回ここで今回のリーグ要素がお目見えするのが恒例となっている。  
...
ステージの最後の方でこのようなオブジェクトがあるはずだ。クリックして起動しよう。
...
後者は可能なら Summon Zonbie にリンクさせよう。

更新された販売品を確認したら、Waypoint から The Coast に戻り、The Mud Flats に向かおう。
